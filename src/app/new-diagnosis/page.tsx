...
export default function NewDiagnosisPage() {
  ...
  const [hasMicPermission, setHasMicPermission] = React.useState<boolean | null>(
    null
  );
  ...
  const onSubmit = async (data: DiagnosisFormValues) => {
    ...
    try {
      ...
      // Data to be displayed locally and to be saved (without local ID)
      let displayData: Omit<Diagnosis, 'id'>;
      let saveData: Omit<Diagnosis, 'id' | 'userId'>;
      ...
      setResult(newDiagnosisForDisplay);
    } catch (error) {
          ...
          {!result && !isLoading && (
            <Card className="w-full">
              <CardHeader>
                ...
                <CardDescription>
                  Choose a method to diagnose your poultry.
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          {isLoading && (
            <div className="flex flex-col items-center justify-center gap-4 text-center min-h-[400px]">
              ...
              <p className="text-muted-foreground max-w-md">
                Our AI veterinarian is examining the case. This may take a
                moment.
              </p>
            </div>
          )}
